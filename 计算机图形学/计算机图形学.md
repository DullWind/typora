...
6. **Radiance**：是为了描述光线，单位面积上的单位立体角的能量![image-20220123153028801](https://gitee.com/MeguminMO/drawing-bed/raw/master//typora/202201231530122.png)

7. BRDF（Bidrectional Reflectance Distribution Function）双向反射分布函数

   1. 不同的材质就定义了不同的BRDF

   2. 用来描述一个光线进入一个物体表面后如何把光线反射出去。dEi(Wi)就是radiance![image-20220123163218627](https://gitee.com/MeguminMO/drawing-bed/raw/master//typora/202201231632878.png)
...
8. 求解定积分
   ...
   1. 蒙特卡洛积分![image-20220124153705366](https://gitee.com/MeguminMO/drawing-bed/raw/master//typora/202201241537776.png)
   ...
   4. 路径追踪伪代码
   5. ![image-20220124222616220](https://gitee.com/MeguminMO/drawing-bed/raw/master//typora/202201242226744.png)
   6. Russian Roulette（RR）:俄罗斯轮盘赌
   7. 面向光源直接采样，找出dw和da的光线，然后直接等量替换就好了。（有点像直接求在面光源上面的立体角）![image-20220124223223006](https://gitee.com/MeguminMO/drawing-bed/raw/master//typora/202201242232456.png)
   8. 改写后的伪代码![image-20220124224059448](https://gitee.com/MeguminMO/drawing-bed/raw/master//typora/202201242241653.png)
